...
SELECT nombreDeColonia FROM distribucion;
...
CREATE TABLE `cliente` (
  `idCliente` int(11) primary key NOT NULL AUTO_INCREMENT UNIQUE,
  `nombre` varchar(30) DEFAULT NULL,
  `apellidos` varchar(60) DEFAULT NULL,
  `direccion` varchar(80) DEFAULT NULL,
  `correoElectronico` varchar(100) DEFAULT NULL UNIQUE,
...
ALTER TABLE `cliente` AUTO_INCREMENT=1600;
...
('Eduardo\'', 'Blanco\'', 'Av. Industrias 403\'', 'Arbol de naranjas en la entrada\'', 'blanco@gmail.com\'', '4425998745\'', 8384, 'hola123'),
('Eva\'', 'Espinoza\'', 'Himlaya 501\'', 'Al lado de un dentista\'', 'espinoza@gmail.com\'', '4425874126\'', 8385, 'hola123'),
('Gemma\'', 'Frias\'', 'Constitucion 420\'', 'Atras del HEB\'', 'frias@gmail.com\'', '4425896354\'', 8386, 'hola123'),
('Pablo\'', 'Farre\'', 'Av. Juarez 60\'', 'Casa rosa\'', 'farre@gmail.com\'', '4425893358\'', 8387, 'hola123'),
('Samira\'', 'Llano\'', 'Av. Lopez Mateos 59\'', 'Casa con un domo\'', 'llano@gmail.com\'', '4425896542\'', 8388, 'hola123'),
('Angelica\'', 'Ripol\'', 'Emiliano Zapata 83\'', 'Al lado de una pasteleria\'', 'ripol@gmail.com\'', '4425874569\'', 8389, 'hola123'),
('Andrea\'', 'Zaragoza\'', '5 de Mayo 852\'', 'Puerta roja con negro\'', 'zaragoza@gmail.com\'', '4425896325\'', 8390, 'hola123');
